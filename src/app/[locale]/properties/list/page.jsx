  ...
  const metadataByTypeAndLocale = {
    sale: {
      th: {
        ...
        description: 'ต้องการซื้อคอนโด บ้าน วิลล่า พูลวิลล่า ในพัทยาและ EEC? The 12 Real Estate Pattaya มีอสังหาริมทรัพย์คุณภาพสูงพร้อมผลตอบแทนการลงทุนสูง',
      ...
      en: {
        title: 'Buy Property in Pattaya: Condos, Houses, Villas & Pool Villas | The 12 Real Estate',
        description: 'Looking to buy property in Pattaya? Explore premium condos, houses, villas & pool villas for sale. The 12 Real Estate Pattaya guides you to your ideal home or high-return investment in Pattaya & EEC.',
      ...
      zh: {
        title: '芭提雅房产购买: 公寓、房屋、别墅与泳池别墅 | The 12 Real Estate',
        description: '在芭提雅及EEC寻找理想房产？The 12 Real Estate Pattaya 提供高品质公寓、房屋、别墅及泳池别墅，助您轻松实现高回报投资或安家梦想。',
      ...
      ru: {
        ...
        description: 'Ищете, где купить кондо, дом, виллу или виллу с бассейном в Паттайе и ЕЭС? The 12 Real Estate Pattaya предлагает объекты с высоким инвестиционным потенциалом. Полное сопровождение покупки для россиян.',
    ...
    rent: {
      th: {
        title: 'เช่าคอนโด บ้าน วิลล่า พูลวิลล่า พัทยา | The 12 Real Estate Pattaya',
        description: 'ค้นหาอสังหาฯ ให้เช่าในพัทยาและ EEC: คอนโด บ้าน วิลล่าหรู และพูลวิลล่าส่วนตัว ทั้งรายวัน รายเดือน รายปี พร้อม The 12 Real Estate Pattaya',
      ...
      en: {
        title: 'Pattaya Property for Rent: Condos, Houses, Villas & Pool Villas | The 12 Real Estate',
        description: 'Find your ideal rental in Pattaya & EEC with The 12 Real Estate Pattaya. Explore condos, houses, luxury villas & private pool villas for short-term or long-term lease.',
      ...
      zh: {
        title: '芭提雅公寓、别墅、房屋租赁 | 短租长租 | The 12 Real Estate',
        description: '在芭提雅及EEC地区寻找理想的租赁房产？The 12 Real Estate Pattaya 提供高品质公寓、房屋、别墅及私人泳池别墅的日租、月租、年租服务。',
      ...
      ru: {
        ...
        description: 'Ищете кондо, дом, виллу или виллу с бассейном в Паттайе? The 12 Real Estate Pattaya предлагает аренду для отдыха и длительного проживания.',

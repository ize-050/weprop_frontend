...
const featureimg_1 = "/assets/images/shape/shape_37.svg"
const featureimg_2 = "/assets/images/media/img_29.jpg"
const featureimg_3 = "/assets/images/assets/screen_03.jpg"
const featureimg_4 = "/assets/images/shape/shape_40.svg"
const featureimg_5 = "/assets/images/media/img_30.jpg"
const featureimg_6 = "/assets/images/assets/screen_04.png"
                  ...
                  <div className="col-xl-7 col-lg-6">
                     <div className="pe-xl-5 me-xxl-3 wow fadeInLeft">
                        <div className="title-one pe-xl-5">
                           <h2 className="font-garamond">Explore & Find your <em>Dream</em> home <span className="star-shape"><img src={featureimg_1} alt="" className="lazy-img" /></span></h2>
                        </div>

                        <div className="row gx-xl-4 align-items-end">
                           <div className="col-7">
                              <div className="media-block position-relative z-1">
                                 <img src={featureimg_2} alt="" className="lazy-img main-img w-100" />
                                 <img src={featureimg_3} alt="" className="lazy-img shapes screen_01" />
                                 <img src={featureimg_4} alt="" className="lazy-img shapes shape_01" />
                              </div>
                           </div>
                           <div className="col-5">
                              <div className="media-block position-relative z-1">
                                 <img src={featureimg_5} alt="" className="lazy-img main-img w-100" />
                                 <img src={featureimg_6} alt="" className="lazy-img shapes screen_02" />
                              </div>
                           </div>
                        </div>
                     </div>

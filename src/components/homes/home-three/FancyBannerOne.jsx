...
const fancyImg_1 = "/assets/images/assets/map_01.svg";

const flag_1 = "/assets/images/logo/flag_01.png";
const flag_2 = "/assets/images/logo/flag_02.png";
const flag_3 = "/assets/images/logo/flag_03.png";
const flag_4 = "/assets/images/logo/flag_04.png";
const flag_5 = "/assets/images/logo/flag_05.png";
const flag_6 = "/assets/images/logo/flag_06.png";
               ...
               <div className="row">
                  <div className="col-xl-7 col-lg-8 m-auto">
                     <div className="title-one text-center pe-xxl-2 ps-xxl-2">
                        <h2 className="font-garamond text-white">Where you are, You will find us every <em>where <span>easily</span></em> <span className="star-shape"><img src={titleShape} alt="" className="lazy-img" /></span></h2>
                     </div>
                  </div>
               </div>
               <div className="map-wrapper position-relative me-auto ms-auto mt-100 xl-mt-50 mb-50">
                  <img src={fancyImg_1} alt="" className="lazy-img w-100" />

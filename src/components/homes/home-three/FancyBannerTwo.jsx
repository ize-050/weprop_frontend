...
const fancyShape_1 = "/assets/images/shape/shape_44.svg"
const fancyShape_2 = "/assets/images/shape/shape_45.svg"
      ...
      <div className="fancy-banner-seven mt-110 xl-mt-80 mb-130 xl-mb-100 lg-mb-80">
         <div className="container container-large">
            <div className="bg-wrapper position-relative z-1 pt-85 lg-pt-70 pb-100 xl-pb-80 lg-pb-70">
               ...
               <img src={fancyShape_1} alt="" className="lazy-img shapes shape_01 wow fadeInLeft" data-wow-delay="0.2s" />
               <img src={fancyShape_2} alt="" className="lazy-img shapes shape_02 wow fadeInRight" />
            </div>
         </div>
      </div>
   )

...
const Feedback = ({ style }) => {
   ...
   return (
      <div className={`feedback-section-four position-relative overflow-hidden z-1 pt-150 lg-pt-120 ${style ? "" : "pb-110 lg-pb-80"}`}>
               ...
               <div className="row">
                  <div className="col-xl-6 col-lg-8">
                     <div className="title-one pe-xxl-5 mb-75 xl-mb-50 wow fadeInUp">
                        {style ? <h3>Client <span>Feedback <img src={titleShape_1} alt="" className="lazy-img" /></span></h3> :
                           <h2 className="font-garamond">Don’t Trust Us, Trust <em>our clients</em> <span className="star-shape"><img src={titleShape_2} alt="" className="lazy-img" /></span></h2>}
         ...
         {!style && <><img src={feedbackShape_1} alt="" className="lazy-img shapes shape_01 wow fadeInDown" data-wow-delay="0.2s" />
            <img src={feedbackShape_2} alt="" className="lazy-img shapes shape_02 wow fadeInUp" /></>}
      </div>
   )
}

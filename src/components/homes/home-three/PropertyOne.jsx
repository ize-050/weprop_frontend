...
const lineShape = "/assets/images/shape/shape_37.svg";
         ...
         <div className="container container-large">
            <div className="position-relative">
               <div className="title-one mb-60 lg-mb-40 wow fadeInUp">
                  <h2 className="font-garamond star-shape">Featured <em>Listing</em> <span className="star-shape"><img src={lineShape} alt="" className="lazy-img" /></span></h2>

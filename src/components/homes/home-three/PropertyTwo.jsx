...
const propertyShape_1 = "/assets/images/shape/shape_37.svg"
const propertyShape_2 = "/assets/images/shape/shape_38.svg"
const propertyShape_3 = "/assets/images/shape/shape_39.svg"
...
const PropertyTwo = ({ style }) => {
   ...
   return (
      <div className="property-listing-four bg-pink-three position-relative z-1 overflow-hidden pt-120 xl-pt-80 pb-110 xl-pb-60 mt-170 xl-mt-140 lg-mt-120">
         <div className="container container-large">
            <div className="position-relative z-1">
               <div className="title-one mb-60 lg-mb-40 wow fadeInUp">
                  <h2 className="font-garamond">New <em>Listings</em> <span className="star-shape"><img src={propertyShape_1} alt="" className="lazy-img" /></span></h2>
         ...
         {!style &&
            <>
               <img src={propertyShape_2} alt="" className="lazy-img shapes shape_01 wow fadeInDown" />
               <img src={propertyShape_3} alt="" className="lazy-img shapes shape_02 wow fadeInUp" />
            </>
         }
      </div>
   )

...
const footerLogo_1 = "/assets/images/logo/logo_05.svg"
const footerShape_1 = "/assets/images/shape/shape_46.svg"
const footerShape_2 = "/assets/images/shape/shape_47.svg"
const footerIcon_1 = "/assets/images/icon/icon_30.svg"
const footerIcon_2 = "/assets/images/icon/icon_31.svg"
import footer_data from "@/data/home-data/FooterData.js";
               ...
               <div className="row justify-content-between">
                  <div className="col-xl-3">
                     <div className="footer-intro position-relative z-1 pt-70 pb-150 lg-pb-20">
                        ...
                        <img src={footerShape_1} alt="" className="lazy-img shapes shape_01 d-none d-xl-block" />
                     </div>
                  </div>
                     ...
                     <div className="ms-xxl-5 ps-xl-5 mt-200 lg-mt-20">
                        <div className="row justify-content-between">
                           ...
                           <div className="col-xxl-3 col-lg-2 d-none d-lg-block">
                              <img src={footerShape_2} alt="" className="lazy-img mt-50" />
                           </div>
                        </div>
                     </div>
                  </div>
